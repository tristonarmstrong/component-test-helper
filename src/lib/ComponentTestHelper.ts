...
> {
  ...
  /**
   * @return {promise} gets the html element
   */
  async get() {
  ...
  /**
   * @return {promise} gets all elements
   */
  async getAll() {
  ...
  /**
   * @return {promise} query all elements
   */
  async query() {
  ...
  /**
   * @return {promise} find this element
   */
  async find() {
  ...
  /**
   * @return {promise} find all elements
   */
  async findAll(): Promise<unknown> {
    return await this.selector.findAll();
  }

  /** clears elements value */
  async clear() {
   ...
   * @param {object} options Possible options to change the typeing behavior
   *  currently only supporting property "realistic"
   * @return {void} void
   */
  ...
  /**
   * finds this element and jest expects it to be in the document
   */
  ...
  /**
   * searches for this element and jest expects it to not be in the document
   */
